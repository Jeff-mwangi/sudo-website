                ...
                <div class="container">
                    <div class="row">
                        <p>Lorem ipsum dolor sit am tempore aliquid dicta cum animi do vero autem ipsum repellat reprehenderit blanditiis.</p>
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/me.jpg" alt="" srcset=""></div>
                            ...
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/mungai.jpg" alt="" srcset=""></div>
                            ...
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/conctact.jpg" alt="" srcset=""></div>
                                <h4>Nancy Maina</h4>
                            ...
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/eras.jpg" alt="" srcset=""></div>
                            ...
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/carol.jpg" alt="" srcset=""></div>
                            ...
                            <div class="col-sm-4">
                                <div id="status">
                                <div class="image"><img src="../main/img/ericG.jpg" alt="" srcset=""></div>
                                <h4>Eric Gacoki</h4>
                                <h5>Android CEO</h5>
